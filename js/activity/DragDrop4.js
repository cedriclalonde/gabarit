...
function DragDrop4() {
    ...
    var dragItem = '.dragDrop4 .drag-item';
    var dragTarget = '.dragDrop4 .drag-target';
    ...
    this.init = function () {
        //        that.showAnswer($('#m1_p4_q1'));
        //        $('.btn-quiz-show-answers').show();
        ...
        $('.targetsContainer').addClass('rounded-corners');


        //        $.each($('.dragDrop'), function(index, value){
        //            var nTry = $(value).attr('data-number-try');
        //            that.setNumTry(parseInt(nTry));
        //
        //            var tryText = $(value).find('.tryText');
        ...
        $(dragItem).draggable({
            ...
            start: function (e, ui) {
                ...
                //                if(numTry === undefined){
                //                    var numTry = parseInt($(root).attr('data-number-try'));
                //                    that.setNumTry(numTry);
                //                }
        ...
        $(dragTarget).droppable({
            ...
            drop: function (e, ui) {
                ...
                console.log($(itemInTarget).css('backgroundColor'));
    ...
    this.checkIfAnswered = function (question) {
        ...
        console.log('dragdrop4 length: ' + length);
    ...
    this.validation = function (question) {
        ...
        var itemsLeft = $(question).find('.choiceContainer .item');
        //        console.log(itemsLeft.length);
    ...
    that.restart = function (question) {
        ...
        //        that.setNumTry(parseInt($(root).attr('data-number-try')));
    ...
    //    that.restart_ = function (e) {
    //        console.log('restart');
    //
    //        $(e.target).hide();
    //        $('.btn-checkAnswer').fadeIn();
    //
    //        $('.btn-checkAnswer').addClass('disabled');
    //        $('.btn-checkAnswer').off(browser, that.checkAnswer);
    //
    //        var root = $(e.target).closest('.cite-question');
    //        var targets = $(root).find('.target');
    //        var choiceContainer = $(root).find('.choiceContainer');
    //
    //        $.each(targets, function (index, value) {
    //            var item = $(value).find('.item');
    //            $(item).removeClass('off');
    //            $(item).css({
    //                position: 'relative',
    //                color: 'black',
